...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-10">
        <h2 class="text-4xl font-display text-textMain tracking-tight">Nuevo Insumo / Material</h2>
        <p class="text-gray-500 font-medium">Incrementa o registra insumos en el inventario.</p>
    </div>
            ...
            <form method="POST" action="{{ route('inventories.store') }}" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" class="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 px-6 text-textMain font-bold focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" required placeholder="Ej: Harina de Trigo, Empanadas de Pollo, etc.">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-primary text-xs font-bold uppercase tracking-widest mb-3 ml-1">Cantidad Inicial</label>
                        <input type="number" min="0" name="quantity" class="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 px-6 text-textMain font-bold focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" required placeholder="0" value="0">
                    </div>
                </div>
